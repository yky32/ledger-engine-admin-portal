...
export function CcTxnPath() {
  const steps = [
    ...
    { n: "2", title: "Ingest", href: "/rules?tab=door", note: "Door admit" },
    { n: "3", title: "Digest", href: "/rules?tab=brain", note: "Brain points" },
    { n: "4", title: "Books", href: "/ledger-entries", note: "DE legs" },
    { n: "5", title: "Tier", href: "/rules?tab=tier", note: "if policy on" },
  ];
  return (
